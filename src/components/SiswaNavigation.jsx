            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                >
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link to="/siswa-dashboard" className={getClassNames("/siswa-dashboard")} aria-current={location.pathname === "/siswa-dashboard" ? "page" : undefined} onClick={handleLinkClick}>Dashboard</Link>
                        </li>
                        <li>
                            <Link to="/datasiswa" className={getClassNames("/datasiswa")} aria-current={location.pathname === "/datasiswa" ? "page" : undefined} onClick={handleLinkClick}>Data Diri</Link>
                        </li>
                    </ul>
                </div>
            </div>
